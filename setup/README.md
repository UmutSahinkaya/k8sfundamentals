...
$ sudo apt-get update
$ sudo apt-get install -y kubelet kubeadm kubectl ((Önce ilk kodu dene olmazsa sağdakini yapıştır!!! sudo apt install -y kubeadm=1.28.1-1.1 kubelet=1.28.1-1.1 kubectl=1.28.1-1.1))
